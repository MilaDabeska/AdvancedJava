...
class Queue<T> {
    ...
    public void enqueue(T element) {
        //го додава елементот на крајот на редот
        if (isEmpty()) {
        ...
        count++; //se dodava element i go broime
    }

    public T dequeue() throws EmptyQueueException {
        // го отстранува елементот на почеток од редот и истиот го враќа
        if (isEmpty()) {
            throw new EmptyQueueException();
        }
        T element = first.getElement();
        first = first.getNext();
        count--; //izbrishavme element pa ja menuvame goleminata
        return element;
    }

    public T peek() throws EmptyQueueException {
        //го враќа елементот на почетокот од редот
        if (isEmpty()) {
            throw new EmptyQueueException();
        }
    ...
    public T inspect() throws EmptyQueueException {
        // го враќа елементот на крајот на редот (не ја менува листата)
        if (isEmpty()) {
            throw new EmptyQueueException();
        }
