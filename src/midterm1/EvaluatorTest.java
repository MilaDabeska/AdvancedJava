    ...
    public static void main(String[] args) {
        ...
        while (sc.hasNext()) {
            ...
            if (parts[0].equals("1")) { //Integers
                ...
                System.out.println(Evaluator2.evaluateExpression(left, right, operator));
                ...
                System.out.println(Evaluator2.evaluateExpression(parts[1], parts[3], operator));
            } else { // Students
                operator = parts[3];
                ...
                System.out.println(Evaluator2.evaluateExpression(s1, s2, operator));
            }
        }
    }
}
