...
//    @Override
//    public int hashCode() {
//        return Objects.hash(getFlatProvision());
//    }
}
...
class FlatPercentProvisionTransaction extends Transaction {
    ...
    public boolean equals(Object o) {
        ...
        if (centsPerDolar != other.centsPerDolar) return false;
        return true;
    }

//    @Override
//    public int hashCode() {
//        return Objects.hash(getCentsPerDolar());
//    }
}
...
class Bank{
    ...
    public Bank(String name, Account[] accounts) {
        this.name = name;
        accounts=Arrays.copyOf(accounts,accounts.length);
    }

    public boolean makeTransaction(Transaction t){
        //врши проверка дали корисникот ги има потребните средства на сметка и дали и двете сметки
        // на кои се однесува трансакцијата се нависитина во банката и ако и двата услови
        // се исполнето ја извршува трансакцијата и враќа true, во спротивно враќа false
        return true;
    }
